...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed left-0 top-16 bottom-0 w-64 border-r overflow-y-auto transition-all duration-300 z-50 md:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}

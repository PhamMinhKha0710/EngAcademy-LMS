 ...
 * Tests exam lifecycle (DRAFT -> PUBLISHED -> CLOSED), submit, double-submit, and scoring.
 */
@SpringBootTest
...
class ExamControllerTest {
    ...
    void setup() throws Exception {
        ...
        optionCorrectId = TestDataFactory.extractLong(q1Result.getResponse().getContentAsString(), "$.data.options[0].id");

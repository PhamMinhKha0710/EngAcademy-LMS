...
public class DevDataSeeder {
        ...
        public CommandLineRunner devSeedData() {
                return args -> {
                        ...
                        // ═══════════════════════════════════════════════
                        // ── HỌC KỲ II (Semester 2) ──
                        // ═══════════════════════════════════════════════
                        List<Lesson> hk2Lessons = seedSemester2(teacher, class6A);
                        ...
                        log.info("Data: 12 Lessons, 129 Vocabulary items, 45 Questions, 8 Exams");
                };
        }
        ...
        private List<Lesson> seedSemester2(User teacher, ClassRoom class6A) {
                ...
                saveOption(q7_1, "action", false); saveOption(q7_1, "educational", true); saveOption(q7_1, "comedy", false); saveOption(q7_1, "cartoon", false);
                Question q7_2 = saveQuestion(lesson7, "TRUE_FALSE", "A 'cartoon' is a programme with animated characters.");
                saveOption(q7_2, "True", true); saveOption(q7_2, "False", false);
                Question q7_3 = saveQuestion(lesson7, "MULTIPLE_CHOICE", "'Khán giả' in English is ___.");
                saveOption(q7_3, "viewer", false); saveOption(q7_3, "audience", true); saveOption(q7_3, "character", false); saveOption(q7_3, "channel", false);
                Question q7_4 = saveQuestion(lesson7, "MULTIPLE_CHOICE", "Which word means 'phát sóng' in English?");
                saveOption(q7_4, "channel", false); saveOption(q7_4, "programme", false); saveOption(q7_4, "broadcast", true); saveOption(q7_4, "compete", false);
                ...
                saveOption(q8_1, "ball", false); saveOption(q8_1, "racket", true); saveOption(q8_1, "helmet", false); saveOption(q8_1, "net", false);
                Question q8_2 = saveQuestion(lesson8, "TRUE_FALSE", "'Gym' means 'phòng tập thể dục' in Vietnamese.");
                saveOption(q8_2, "True", true); saveOption(q8_2, "False", false);
                Question q8_3 = saveQuestion(lesson8, "MULTIPLE_CHOICE", "A person who plays sports professionally is called an ___.");
                saveOption(q8_3, "player", false); saveOption(q8_3, "viewer", false); saveOption(q8_3, "athlete", true); saveOption(q8_3, "coach", false);
                Question q8_4 = saveQuestion(lesson8, "MULTIPLE_CHOICE", "Which of these is NOT a sport?");
                saveOption(q8_4, "cycling", false); saveOption(q8_4, "karate", false); saveOption(q8_4, "channel", true); saveOption(q8_4, "swimming", false);
                ...
                saveOption(q9_1, "True", true); saveOption(q9_1, "False", false);
                Question q9_2 = saveQuestion(lesson9, "MULTIPLE_CHOICE", "'Đông đúc' in English is ___.");
                saveOption(q9_2, "modern", false); saveOption(q9_2, "crowded", true); saveOption(q9_2, "famous", false); saveOption(q9_2, "wonderful", false);
                Question q9_3 = saveQuestion(lesson9, "MULTIPLE_CHOICE", "A place of worship in Asia is often called a ___.");
                saveOption(q9_3, "landmark", false); saveOption(q9_3, "pagoda", true); saveOption(q9_3, "town", false); saveOption(q9_3, "cathedral", false);
                Question q9_4 = saveQuestion(lesson9, "MULTIPLE_CHOICE", "Which word means 'ngon miệng'?");
                saveOption(q9_4, "rainy", false); saveOption(q9_4, "sunny", false); saveOption(q9_4, "tasty", true); saveOption(q9_4, "crowded", false);
                ...
                saveOption(q10_1, "solar energy", true); saveOption(q10_1, "wireless energy", false); saveOption(q10_1, "hi-tech energy", false); saveOption(q10_1, "space energy", false);
                Question q10_2 = saveQuestion(lesson10, "TRUE_FALSE", "'Wireless' means 'having no wires or cables'.");
                saveOption(q10_2, "True", true); saveOption(q10_2, "False", false);
                Question q10_3 = saveQuestion(lesson10, "MULTIPLE_CHOICE", "A small house in the countryside is called a ___.");
                saveOption(q10_3, "space station", false); saveOption(q10_3, "cottage", true); saveOption(q10_3, "UFO", false); saveOption(q10_3, "helicopter", false);
                Question q10_4 = saveQuestion(lesson10, "MULTIPLE_CHOICE", "'Công việc nhà' in English is ___.");
                saveOption(q10_4, "homework", false); saveOption(q10_4, "housework", true); saveOption(q10_4, "teamwork", false); saveOption(q10_4, "network", false);
                ...
                saveOption(q11_1, "Return", false); saveOption(q11_1, "Remove", false); saveOption(q11_1, "Recycle", true); saveOption(q11_1, "Rebuild", false);
                Question q11_2 = saveQuestion(lesson11, "TRUE_FALSE", "'Litter' means 'xả rác' in Vietnamese.");
                saveOption(q11_2, "True", true); saveOption(q11_2, "False", false);
                Question q11_3 = saveQuestion(lesson11, "MULTIPLE_CHOICE", "We put recyclable waste in a ___.");
                saveOption(q11_3, "rubbish bag", false); saveOption(q11_3, "recycling bin", true); saveOption(q11_3, "plastic bag", false); saveOption(q11_3, "dustpan", false);
                Question q11_4 = saveQuestion(lesson11, "MULTIPLE_CHOICE", "Which phrase means 'sống xanh'?");
                saveOption(q11_4, "go red", false); saveOption(q11_4, "go blue", false); saveOption(q11_4, "go green", true); saveOption(q11_4, "go clean", false);
                ...
                saveOption(q12_1, "iron", true); saveOption(q12_1, "guard", false); saveOption(q12_1, "water", false); saveOption(q12_1, "plant", false);
                Question q12_2 = saveQuestion(lesson12, "TRUE_FALSE", "'Repair' means 'sửa chữa' in Vietnamese.");
                saveOption(q12_2, "True", true); saveOption(q12_2, "False", false);
                Question q12_3 = saveQuestion(lesson12, "MULTIPLE_CHOICE", "The ___ of the robot is 50 kilograms.");
                saveOption(q12_3, "height", false); saveOption(q12_3, "weight", true); saveOption(q12_3, "price", false); saveOption(q12_3, "age", false);
                Question q12_4 = saveQuestion(lesson12, "MULTIPLE_CHOICE", "Which is NOT something a robot can do?");
                saveOption(q12_4, "do the dishes", false); saveOption(q12_4, "iron clothes", false); saveOption(q12_4, "have feelings", true); saveOption(q12_4, "guard the house", false);
